...
public class MainPageApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        //welcome page
        FXMLLoader fxmlLoader = new FXMLLoader(MainPageApplication.class.getResource("Decor-CateringPage.fxml")); //da hayfta7 el logged in page w law enty 3ayza to sign up
