...
public class DBUtils {
    ...
    public static void signUpUser(ActionEvent event, String username, String password, String email, int phoneNum){
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/loginuser", "root", "123456789mManar"); //hena change ur password  AND THE NAME OF THE FILE ana 3andy (loginuser enty i guess javafx)!!
